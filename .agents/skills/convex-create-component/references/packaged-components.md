...
Read this file when the user wants a reusable npm package or a component shared across multiple
apps.
...
When building a packaged component, make sure the bundled output exists before the example app tries
to consume it.
