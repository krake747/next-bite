...
export function Header({ count }: { count: () => number }) {
    return (
        <header class="px-6 py-16 sm:py-24 lg:py-32 lg:px-8 dark:bg-neutral-900">
            <div class="mx-auto max-w-2xl text-center">
                <div class="inline-flex size-12 sm:size-16 items-center justify-center rounded-2xl bg-flame-pea-100 text-flame-pea-600">
