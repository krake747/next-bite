...
- Playwright (E2E tests), Vitest (unit + browser tests)
...
Vitest (unit + browser) and Playwright (E2E). See `docs/agents/testing.md`.

### Toolchain

Build, lint, test, and sandcastle commands. See `docs/agents/toolchain.md`.
